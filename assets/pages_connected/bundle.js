(function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
		...
		$(function () {
			...
			let simular = function () {
				...
				if ((valor > 0 || !isNaN(valor)) || (taxa > 0 || !isNaN(taxa)) || (parcelas > 0 || !isNaN(parcelas))) {
					...
					$("#resultado").html("");
					$("#resultado").append("<h2>Simulação  <span>PRICE<span> ( Prestação Fixa )</h2><br>");
					$("#resultado").append("<div class='column-p'>Valor da Prestação é: <span class='valor-prestacao'>" + simuladorA.financiarPrice() + "</span></div>");

					$("#resultado").append("<div class='column-p'>Valor Total do Financiamento Pago é: <span class='valor-total-pago'>" + simuladorA.calculaTotalPagoPrice() + "</span></div>");
					$("#resultado").append("<div class='column-p'>Valor Total de Juros Pago é: <span class='valor-total-juros'>" + simuladorA.calculaTotalJurosPrice() + "</span></div>");

					$("#resultado").append("<h2>Simulação <span>SAC<span> ( Prestação Decrescente )</h2>");
					...
					$("#resultado").append("<div class='parcelas-sac'><h2>Os Valores das Prestações são: </h2><br>" + simuladorB.listaSacHTML + "</div>");
					$("#resultado").append("<div class='column-p'>Valor Total do Financiamento Pago é: <span class='valor-total-pago-sac'>" + simuladorB.calculaTotalPagoSac() + "</span></div>");
					$("#resultado").append("<div class='column-p'><a>Valor Total de Juros Pago é: </a><span class='valor-total-juros-sac'>" + simuladorB.calculaTotalJurosSac() + "</span></div>");
	...
	}, { "../controller/financiarController": 1, "jquery": 2 }]
}, {}, [3]);
